...
params.PI = 3.14159265358979323846264338327950288;  // BSSN.BSSN_stress_energy_source_terms::PI
params.eta = 2.0;  // BSSN.BSSN_gauge_RHSs::eta
params.diss_strength = 0.1;  // ScalarFieldCollapse::diss_strength
